 ...
 * 
 * This component contains the sidebar content that's shared between
 * desktop and mobile views. It adapts its styling and behavior
 * based on the isMobile prop.
 */
export default function SharedSidebar({ isMobile = false, onLinkClick, onClose }: SharedSidebarProps) {
  return (
    <aside className={`
      bg-[var(--color-background)] border-r border-[var(--color-border)] flex flex-col transition-colors duration-300
      ${isMobile 
